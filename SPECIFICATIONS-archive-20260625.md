> **ARCHIVED 2026-06-28.** This is the original 22-spec product backlog (SPEC-01…SPEC-22),
> delivered on branch `enhancement/unit-converter-20260625` (PR #3). It is retained for history
> only and no longer drives development. Active work is tracked in `SPECIFICATIONS.md`
> (post-review remediation list). Do not implement from this file.
